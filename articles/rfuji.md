# Getting started with rfuji

`rfuji` assesses how well a research data object satisfies the FAIR
...
Automated FAIR scores have well-known blind spots. `rfuji` surfaces
three:
